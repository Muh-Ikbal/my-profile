...
const ProjectCard = ({ imgUrl, title, description, gitUrl, linkPreview }) => {
    ...
    whileTap={{ scale: 0.9 }}>
            ...
            >
                <div className="overlay gap-2 rounded items-center justify-center absolute left-0 right-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-50 transition-all duration-500">
                    <Link
                        href={gitUrl}
            ...
            <div className="text-white bg-[#181818] rounded py-6 px-4">
